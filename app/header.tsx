...
const Navbar = () => {
  ...
  return (
    <div className="text-white font-kanit">
      ...
      <div className={`fixed inset-y-0 w-80 bg-ad-dark text-white transition-all duration-300 z-50 p-6 ${menu ? 'left-0' : '-left-80'}`}>
      ...
      <div className={`fixed inset-0 w-full duration-300 bg-black backdrop-blur-xl bg-opacity-50 z-40 ${menu ? '' : 'opacity-0 backdrop-blur-none pointer-events-none'} `} onClick={toggleMenu} />
    </div>
