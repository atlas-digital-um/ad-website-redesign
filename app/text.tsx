...
export const pastProjects = [
  {
    ...
    description: (
      <div>
        ShapeLog is a fitness company whose devices feature sensors to collect
        data from weight training machines. We have implemented a display for
        their circuit class that shows the class’ progress and goals in real
        time from data collected from the machines.
      </div>
    ),
    photo: shapelog,
  ...
  },
  {
    ...
    description: (
      <div>
        Ascend Tech is a platform that aims to take the best aspects of services
        like Glassdoor and Levels.fyi to provide a more holistic picture of a
        company and their culture using crowdsourced data.
      </div>
    ),
    photo: ascendTech,
  ...
  },
  {
    ...
    description: (
      <div>
        BuyMySpot provides a peer-to-peer marketplace for parking solutions on
        college campuses. Check out the live website{" "}
        <Link
